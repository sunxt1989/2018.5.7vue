        ...
        <div class="w">
            <div class="content" :style="{height:screenHeight}">
                ...
                <el-radio-group v-model="radio" @change="radioChange">
                    <el-radio-button label="付款单审批"></el-radio-button>
                    <el-radio-button label="采购内容"></el-radio-button>
                </el-radio-group>
...
<script type="text/ecmascript-6">
    ...
    export default{
        data(){
            return{
                showContents:true,//展示页面所显示的内容，true为付款单审批 false为采购内容
                radio:'付款单审批',
                unPayMoney:'',//待付款
                money:'',//本次付款
                payType:'2',//结算方式
...
//                console.log(val);
        ...
        methods: {
            ...
            submit(n){
                ...
                var url = '';
                if(n == 2){
                    url = addUrl.addUrl('approvalPurchaseConfirmAgree')
...
//                console.log(headerHeight);
        ...
        created(){
            ...
            let url = addUrl.addUrl('seePurchasePayment')
...
//                    console.log(this.supplierList);
                    ...
                    this.attachUrlJson2 = purchase.attachUrlJson;
