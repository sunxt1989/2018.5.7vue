        ...
        <div class="w">
            <div class="left" :style="{height:screenHeight}">
                <el-table :data="tableData" class="blueList">
                    ...
                    <el-table-column prop="money" label="业务金额" sortable align="center">
                    ...
                    <el-table-column label="操作" width="80px" align="center">
                        <template slot-scope="scope">
                            <span class="operation">
                                ...
                                <router-link v-if="scope.row.auditFlg == 4" :to="{name:'seeCollection',params:{debitId:scope.row.idString}}" class="see">
