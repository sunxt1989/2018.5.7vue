        ...
        <div class="w">
            <div class="left" :style="{height:screenHeight}">
                <div class="choose">
                    ...
                    <span class="record">科目编号：</span>
                    <el-input placeholder="请输入内容" size="small" v-model="startSubject" class="chooseSubject" @change="changeSubject">
                        <el-button slot="append" icon="el-icon-search" @click="addClick"></el-button>
                    </el-input>
                    <el-button @click="query" class="query" size="small" type="primary">查询</el-button>

                    <el-dialog title="科目编号" :visible.sync="dialogTableVisible" showConfirmButton="true" top="20px">
                ...
                <el-table :data="tableData" class="single" :height="tableDataHeight">
                    <el-table-column prop="riqi" label="日期" align="center"></el-table-column>
                    ...
                    <el-table-column prop="jiefang" label="借方" align="center"></el-table-column>
                    <el-table-column prop="daifang" label="贷方" align="center"></el-table-column>
    ...
    export default {
        ...
        methods:{
            ...
            clickCheck(data,checkedKeys){
               //判断一下当选择的为父级科目时是不能被勾选的，只有选择最底层的子级科目才能被选中
...
//                console.log(this.url1);
                let url = addUrl.addUrl('detailAccount')
                let params = new URLSearchParams();
