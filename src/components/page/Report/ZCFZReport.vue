            ...
            <div class="w">
                <div class="content cf">
                    ...
                    <el-table class="single" :data="tableData3">
                        <el-table-column align="center" prop="zichan_1" label="资产"></el-table-column>
                        <el-table-column align="center" prop="hangci_2" label="行次"></el-table-column>
                        <el-table-column align="center" prop="qimoyue_3" label="期末余额"></el-table-column>
                        <el-table-column align="center" prop="nianchuyue_4" label="年初余额"></el-table-column>
                        <el-table-column align="center" prop="fuzhaihesuoyouzhequanyi_5" label="负债和所有者权益"></el-table-column>
                        <el-table-column align="center" prop="hangci_6" label="行次"></el-table-column>
                        <el-table-column align="center" prop="qimoyue_7" label="期末余额"></el-table-column>
                        <el-table-column align="center" prop="nianchuyue_8" label="年初余额"></el-table-column>
                    </el-table>
...
<script type="text/ecmascript-6">
    ...
    export default{
        ...
        methods: {
            ...
            axios(){
                this.loading = true
                let url1 = addUrl.addUrl('ZCFZReportExcel');
                let url2 = addUrl.addUrl('ZCFZReportPDF');
                let params = new URLSearchParams();
                let url = addUrl.addUrl('ZCFZReportList');
...
//                        console.log(response);
        ...
        created(){
            let url = addUrl.addUrl('ZCFZReport');
            axios.post(url)
                .then(response=> {
//                    console.log(response);
                    let data = response.data.value
