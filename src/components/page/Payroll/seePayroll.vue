...
//                    console.log(response);
                    ...
                    if(salaryItem.id != '0'){
                        this.shouldWages = salaryItem.shouldWages
                        ...
                        this.employmentInjuryInsurancePerson = salaryItem.employmentInjuryInsurancePerson
                        this.maternityInsurancePerson = salaryItem.maternityInsurancePerson
                        this.housingProvidentFundPerson = salaryItem.housingProvidentFundPerson
                        this.insuranceSumPerson = salaryItem.insuranceSumPerson
                        ...
                        this.insuranceSumCompany = salaryItem.insuranceSumCompany
