    ...
    <div v-loading.fullscreen.lock="loading">
        <div class="w cf">
            <div class="top">
                ...
                <el-button @click="model(2)" size="small" type="danger" class="sub2" :loading="isLoading">记账</el-button>
            </div>
        </div>
        <div class="w">
            <div class="content" :style="{height:screenHeight}">
                ...
                <ul class="list cf">
                    <li class="pt">
                        ...
                        <el-select class="sel" v-model="scene" placeholder="请选择" @change="changeScene">
                            <el-option
                    ...
                    <li class="sm" v-show="payTypeFlg == 1">
                        ...
                        <el-select class="sel" v-model="mode" placeholder="请选择" @change="payTypeChange">
                            <el-option
                    ...
                    <li class="sm" v-show="bankCodeFlg == 1">
                        ...
                        <el-select class="sel" v-model="bankCode" placeholder="请选择" :disabled="ChangeBankCode">
                            <el-option
                    ...
                    <li class="sm" v-show="taxMoneyFlg==1">
                        ...
                        <input class="ipt" type="text" v-model="taxAmount" maxlength="20" @change="changeTaxAmount">
                    </li>
