    ...
    export default{
        ...
        methods: {
            ...
            numberMoney(n){
                ...
                let dealCost = this.dealCost
                if(n == 1 && !str.test(dealTotalMoney)){
                    this.$message.error('请正确输入价税合计金额');
                    this.dealTotalMoney = '0.00';
                    return
                }
                if(n ==2 && !str.test(dealCost)){
                    this.$message.error('请正确输入处置费用');
                    this.dealCost = '0.00';
                    return
                }
                this.dealTotalMoney  = number.number(dealTotalMoney);
...
//                        console.log(response);
                        ...
                        if(this.status < 3){
                            ...
                            this.dealTotalMoney = fixedAssets.dealTotalMoney;
                            this.dealTaxRate = fixedAssets.dealTaxRate;
                            this.dealCost = fixedAssets.dealCost;
                            this.dealDateYMD = fixedAssets.dealDateYMD;
                        }
